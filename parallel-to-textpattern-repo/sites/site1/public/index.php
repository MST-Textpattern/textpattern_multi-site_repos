...
if (!isset($txpcfg['table_prefix'])) {
    ...
    exit('config.php is missing or corrupt.  To install Textpattern, visit <a href="http://admin.mysite.com/setup/">http://admin.mysite.com/setup/</a> (replace with your own admin subdomain)');
}
